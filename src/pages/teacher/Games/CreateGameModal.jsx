...
import { FiX, FiPlus, FiTrash2, FiUsers, FiLoader } from 'react-icons/fi';
import { API_URL, getAuthHeaders } from './utils';

const CreateGameModal = ({ type, onClose, onCreated }) => {
      ...
      <div className="bg-white rounded-2xl max-w-3xl w-full p-8 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex gap-3 pt-4">
            ...
            >
              {submitting ? 'Đang tạo...' : type === 'quiz' ? 'Tạo Quiz' : 'Tạo Vòng quay'}
            </button>
          </div>
        </form>
      </div>
