      ...
      <div className="bg-gradient-to-r from-emerald-500 to-teal-500 rounded-2xl p-6 text-white">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-emerald-100">Quản lý thông tin cá nhân và bảo mật</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-emerald-50 to-teal-50 p-6">
          <div className="flex items-center gap-5">
            <div className="w-20 h-20 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-full flex items-center justify-center text-white text-3xl font-bold shadow-lg ring-4 ring-white">
              {currentUser?.avatar ? (
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm font-medium text-gray-800">Giáo viên</p>
            </div>
          </div>
            ...
            <form onSubmit={handleProfileSubmit} className="p-6 space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-emerald-500 text-white rounded-xl hover:bg-emerald-600 disabled:opacity-50 font-medium transition-colors"
                >
        ...
        <div className="fixed inset-0 bg-black/50 z-[70] flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl max-w-sm w-full p-6">
            <div className={`flex items-center justify-center w-12 h-12 rounded-full mx-auto mb-4 ${
              showConfirm === 'profile' ? 'bg-emerald-100' : 'bg-orange-100'
            }`}>
              {showConfirm === 'profile'
